...
gates (T032), vault (T033 → ADR 0017). Dev `expertisesPage` seeded + rendered (gate off):
...
- **Motion: static by decision** (ADR 0017 §Motion, as on the about page) — T018/T023 record the
